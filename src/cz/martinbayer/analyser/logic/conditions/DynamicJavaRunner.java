package cz.martinbayer.analyser.logic.conditions;
...
public class DynamicJavaRunner {
	...
	private static String classOutputFolder = "C:\\classes\\demo";
	...
	private static JavaFileObject getJavaFileObject() {
		StringBuilder contents = new StringBuilder("package math;"
				...
				+ "  public void testAdd(int number) { "
				+ "    System.out.println(200+300+number); " + "  } " + "} ");
